...
enum class Experience(
    ...
    First(
        number = "01",
        jobPosition = "SDE-3 < > Platform Lead",
        description = "• Technical Leadership & Innovation: Architected and developed a custom in-house chatbot using MQTT protocol for real-time chat capabilities with customer support, significantly improving customer engagement and reducing response times.\n" +
                "• Advanced Integration: Built AudioBot on top of the chatbot architecture, enabling real-time streaming and transcription capabilities, enhancing the customer support experience.\n" +
                "• Performance Optimization: Refactored the app's network layer to enhance API performance and enable granular observability of API calls, reducing overall latency by 19% and increasing API success rates from 92.5% to 97.3%.\n" +
                "• Framework Development: Led the Android platform team to build central frameworks that optimize performance, improve scalability, and boost developer productivity across the organization.\n" +
                "• DevOps Enhancement: Strengthened the CI/CD pipeline for faster deployments and streamlined releases, reducing build times and improving release reliability.\n" +
                "• UX Improvements: Spearheaded the homepage revamp project, introducing view caching for all L0 home pages, resulting in significantly improved app performance and faster load times.\n" +
